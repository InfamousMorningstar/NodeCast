...
export default async function fileManagementRoutes(server: FastifyInstance) {
  ...
  server.get('/api/files/:id/metadata', {
  ...
  server.delete('/api/files/:id/tags/:tag', {
    preHandler: [userMiddleware]
  }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const user = (request as any).user;
  ...
  // Search files by tag
  server.get('/api/files/search/tags/:tag', {
    preHandler: [userMiddleware]
  }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const user = (request as any).user;
  ...
  server.get('/api/files/organization/suggestions', {
    preHandler: [userMiddleware]
  }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const user = (request as any).user;
  ...
  server.post('/api/files/organization/apply', {
    preHandler: [userMiddleware]
  }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const user = (request as any).user;
      ...
      const selectedSuggestions = allSuggestions.filter((s: any) => 
        suggestionIds.includes(s.fileId)
      );
  ...
  // Bulk tag files
  server.post('/api/files/bulk/tags', {
    preHandler: [userMiddleware]
  }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const user = (request as any).user;
  ...
  server.post('/api/files/:id/attributes', {
    preHandler: [userMiddleware]
  }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const user = (request as any).user;
  ...
  server.get('/api/files/:id/attributes', {
    preHandler: [userMiddleware]
  }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const user = (request as any).user;
  ...
  server.get('/api/files/:id/auto-tags', {
    preHandler: [userMiddleware]
  }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const user = (request as any).user;
  ...
  server.get('/api/files/:id/smart-folders', {
    preHandler: [userMiddleware]
  }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const user = (request as any).user;
