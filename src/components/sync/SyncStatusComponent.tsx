...
export function SyncStatusComponent({
  ...
  return (
    <div className='bg-white rounded-lg shadow-md p-6'>
        ...
        <div className='mb-6'>
          ...
          <div className='grid grid-cols-3 gap-2 text-sm'>
            <div>
              ...
              <span className='font-medium'>{formatBandwidth(syncStatus.bandwidth.upload)}</span>
            </div>
            <div>
              <span className='text-gray-500'>Down:</span>{' '}
              <span className='font-medium'>{formatBandwidth(syncStatus.bandwidth.download)}</span>
            </div>
            <div>
              <span className='text-gray-500'>Available:</span>{' '}
              <span className='font-medium'>{formatBandwidth(syncStatus.bandwidth.available)}</span>
            </div>
          </div>
        </div>
      )}
      ...
      {conflicts.length > 0 && (
        <div className='mb-4'>
          <div className='text-sm text-yellow-600 mb-2'>{conflicts.length} conflicts need resolution</div>
